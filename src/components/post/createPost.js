...
import { useRef ,useCallback, useState} from  'react/cjs/react.development';
import { createReactEditorJS } from 'react-editor-js'
import { useAuth } from '../../contexts/authContext';
import { addPost, imageArray, uploadImage, getAuthor } from '../../firebaseConfig';
...
const CreatePost = () => {
    ...
    return ( 
        <div className="post-container">
            <form className="submit-form" ref={form} onSubmit={(e)=>{handleSave(e)}}>
            <input type="text" name="title" required placeholder="your title here"/>
            <input type="text" name="topic" required placeholder="enter the topic"/>
